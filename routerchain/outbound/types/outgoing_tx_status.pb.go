...
const (
	...
	OUTGOING_TX_ACK_VALIDATED        OutgoingTxStatus = 3
	OUTGOING_TX_ACK_READY_TO_EXECUTE OutgoingTxStatus = 4
	OUTGOING_TX_ACK_EXECUTED         OutgoingTxStatus = 5
	OUTGOING_TX_ACK_EXECUTION_FAILED OutgoingTxStatus = 6
)
...
var OutgoingTxStatus_name = map[int32]string{
	...
	3: "OUTGOING_TX_ACK_VALIDATED",
	4: "OUTGOING_TX_ACK_READY_TO_EXECUTE",
	5: "OUTGOING_TX_ACK_EXECUTED",
	6: "OUTGOING_TX_ACK_EXECUTION_FAILED",
}
...
var OutgoingTxStatus_value = map[string]int32{
	...
	"OUTGOING_TX_ACK_VALIDATED":        3,
	"OUTGOING_TX_ACK_READY_TO_EXECUTE": 4,
	"OUTGOING_TX_ACK_EXECUTED":         5,
	"OUTGOING_TX_ACK_EXECUTION_FAILED": 6,
}
...
var fileDescriptor_7e38f3412884ec83 = []byte{
	...
	0x4f, 0xcc, 0xab, 0x84, 0x48, 0x69, 0x9d, 0x63, 0xe6, 0x12, 0xf0, 0x87, 0x5a, 0x19, 0x52, 0x11,
	...
	0xba, 0xe6, 0x2a, 0xe0, 0x94, 0x17, 0xb2, 0xe1, 0x92, 0x44, 0x97, 0x0b, 0x73, 0xf4, 0xf1, 0x74,
	0x01, 0xbb, 0x94, 0x59, 0x4a, 0xb6, 0x6b, 0xae, 0x02, 0x6e, 0x05, 0x42, 0x5e, 0x5c, 0x0a, 0x98,
	0x26, 0x3b, 0xba, 0x44, 0xc6, 0x87, 0xf8, 0xc7, 0xbb, 0x46, 0xb8, 0x3a, 0x87, 0x86, 0xb8, 0x0a,
	0xb0, 0x48, 0xa9, 0x74, 0xcd, 0x55, 0x20, 0xa8, 0x0e, 0x9b, 0x2f, 0xa0, 0x52, 0x2e, 0x02, 0xac,
	0xd8, 0x7d, 0x01, 0x93, 0xc7, 0xe6, 0x0e, 0x88, 0x9c, 0xa7, 0xbf, 0x5f, 0xbc, 0x9b, 0xa3, 0xa7,
	0x8f, 0xab, 0x8b, 0x00, 0x1b, 0x76, 0x77, 0xa0, 0xab, 0x93, 0x62, 0xe9, 0x58, 0x2c, 0xc7, 0xe0,
	...
	0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x90, 0xc4, 0xa3, 0x0b, 0x4b, 0x4c, 0x30, 0x3e,
	0x38, 0x35, 0xe9, 0x57, 0xe8, 0xc3, 0x53, 0x63, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x58,
	0x9d, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xc5, 0xa9, 0x5b, 0xe9, 0xa6, 0x02, 0x00, 0x00,
}
