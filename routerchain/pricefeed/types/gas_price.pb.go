...
// source: routerprotocol/routerchain/pricefeed/gas_price.proto
...
func (*GasPrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_3870f421a7b6fd1f, []int{0}
}
...
func init() {
	proto.RegisterType((*GasPrice)(nil), "routerprotocol.routerchain.pricefeed.GasPrice")
}

func init() {
	proto.RegisterFile("routerprotocol/routerchain/pricefeed/gas_price.proto", fileDescriptor_3870f421a7b6fd1f)
}

var fileDescriptor_3870f421a7b6fd1f = []byte{
	// 241 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *GasPrice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ResolveTime != 0 {
		i = encodeVarintGasPrice(dAtA, i, uint64(m.ResolveTime))
		i--
		dAtA[i] = 0x28
	}
	if m.Decimals != 0 {
		i = encodeVarintGasPrice(dAtA, i, uint64(m.Decimals))
		i--
		dAtA[i] = 0x20
	}
	if m.GasPrice != 0 {
	...
	if len(m.ChainId) > 0 {
		...
		i = encodeVarintGasPrice(dAtA, i, uint64(len(m.ChainId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.PriceFeeder) > 0 {
		...
		i = encodeVarintGasPrice(dAtA, i, uint64(len(m.PriceFeeder)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *GasPrice) Size() (n int) {
	...
	if m.Decimals != 0 {
		n += 1 + sovGasPrice(uint64(m.Decimals))
	}
	if m.ResolveTime != 0 {
		n += 1 + sovGasPrice(uint64(m.ResolveTime))
	}
	return n
}
