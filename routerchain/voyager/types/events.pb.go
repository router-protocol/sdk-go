...
type EventFundDepositRequestCreated struct {
	...
	DestAmount         cosmossdk_io_math.Int `protobuf:"bytes,11,opt,name=destAmount,proto3,customtype=cosmossdk.io/math.Int" json:"destAmount"`
	...
	PartnerId          cosmossdk_io_math.Int `protobuf:"bytes,16,opt,name=partner_id,json=partnerId,proto3,customtype=cosmossdk.io/math.Int" json:"partner_id"`
...
type EventDepositInfoUpdatedRequestCreated struct {
	...
	FeeAmount          cosmossdk_io_math.Int `protobuf:"bytes,10,opt,name=feeAmount,proto3,customtype=cosmossdk.io/math.Int" json:"feeAmount"`
...
var fileDescriptor_6ec15800680f195b = []byte{
	...
	,
}
