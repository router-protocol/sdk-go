...
type FundDepositEventPacket struct {
	...
	DestAmount         cosmossdk_io_math.Int `protobuf:"bytes,8,opt,name=dest_amount,json=destAmount,proto3,customtype=cosmossdk.io/math.Int" json:"dest_amount"`
...
type DepositInfoUpdateEventPacket struct {
	...
	FeeAmount          cosmossdk_io_math.Int `protobuf:"bytes,7,opt,name=fee_amount,json=feeAmount,proto3,customtype=cosmossdk.io/math.Int" json:"fee_amount"`
...
var fileDescriptor_77fe4f92cfa49a1a = []byte{
	...
	,
}
