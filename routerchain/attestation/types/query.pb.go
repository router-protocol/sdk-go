...
type QueryGetValsetConfirmationRequest struct {
	...
	DestChainType types.ChainType `protobuf:"varint,3,opt,name=dest_chain_type,json=destChainType,proto3,enum=routerprotocol.routerchain.multichain.ChainType" json:"dest_chain_type,omitempty"`
}
...
func (m *QueryGetValsetConfirmationRequest) GetDestChainType() types.ChainType {
	if m != nil {
...
func (m *QueryAllValsetConfirmationRequest) GetDestChainType() types.ChainType {
	if m != nil {
		return m.DestChainType
	}
	return types.CHAIN_TYPE_NONE
...
type QueryFetchOrchestratorValidatorResponse struct {
	Validator types1.Validator `protobuf:"bytes,1,opt,name=validator,proto3" json:"validator"`
}
...
func (m *QueryFetchOrchestratorValidatorResponse) GetValidator() types1.Validator {
	if m != nil {
		return m.Validator
	}
...
var fileDescriptor_0160bcb68cc040a5 = []byte{
	...
	,
}
...
func (m *QueryGetValsetConfirmationRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DestChainType != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.DestChainType))
		i--
		dAtA[i] = 0x18
	}
...
func (m *QueryGetValsetConfirmationRequest) Size() (n int) {
	...
	if m.DestChainType != 0 {
		n += 1 + sovQuery(uint64(m.DestChainType))
	}
	return n
}
